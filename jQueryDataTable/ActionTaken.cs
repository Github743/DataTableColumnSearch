...
namespace jQueryDataTable
{
    ...
    public partial class ActionTaken
    {
        ...
        public ActionTaken()
        {
            this.ActionTakenAttachments = new HashSet<ActionTakenAttachment>();
        }
    
        public int ActionTakenId { get; set; }
        public int ReportableEventId { get; set; }
        public string ActionTakenInfo { get; set; }
        ...
        public virtual ICollection<ActionTakenAttachment> ActionTakenAttachments { get; set; }
    }
}
