...
namespace jQueryDataTable
{
    ...
    public partial class InjuryDetail
    {
        ...
        public InjuryDetail()
        {
            this.InjuryDetailAttachments = new HashSet<InjuryDetailAttachment>();
        }
    
        public int InjuryDetailId { get; set; }
        public int ReportableEventId { get; set; }
        public int BodilyLocationofInjuryId { get; set; }
        ...
        public virtual ICollection<InjuryDetailAttachment> InjuryDetailAttachments { get; set; }
    }
}
